...
function get_common_form()
{
	 ...
	 */
			...
			(function()
			{
				...
				var $SubCommon =$(this).parent().next()
				console.log($SubCommon)
				//发送get请求
				...
				if(show_common == 'true'){
						...
						(
							...
							function(data)
							{
								...
								$SubCommon.html(data).children("form").css("display","block")
